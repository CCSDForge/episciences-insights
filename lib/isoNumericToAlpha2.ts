// world-atlas's countries-110m.json keys each feature by its numeric
// ISO 3166-1 id rather than the alpha-2 code our data uses everywhere else —
// this is the lookup table bridging the two. Shared between WorldMap.tsx and
// any other component reading that same topology (e.g. for country
// centroids), so the mapping only needs to be maintained in one place.
