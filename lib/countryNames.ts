// A static ISO 3166-1 alpha-2 -> English short name table, deliberately NOT
// backed by Intl.DisplayNames: Node's bundled ICU/CLDR and a browser's
// independently-updated ICU can disagree on the short name for a handful of
// codes (observed: HK -> "Hong Kong" server-side vs "Hong Kong SAR China"
// client-side), which is a hard SSR/CSR hydration mismatch for any component
// that renders the name during first paint. A fixed table can't drift.
